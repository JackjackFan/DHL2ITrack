...
def train_mdnet():
    ...
    for i,video_name in enumerate(video_list):
        ...
        for j,(ll_img_file,t_img_file) in enumerate(zip(lowlight_img_list,T_img_list)):
            channel_1_sava_path = os.path.join(lolt_mfdim_save_path,video_name,'enhance',ll_img_file.split('.jpg')[0]+'_enhance.jpg')
            channel_3_sava_path = os.path.join(lolt_mfdim_save_path,video_name,'fusion',t_img_file.split('.jpg')[0]+'_fusion.jpg')
     
            os.rename(channel_1_sava_path,channel_1_sava_path.split('_enhance')[0]+'.jpg')
            os.rename(channel_3_sava_path,channel_3_sava_path.split('_fusion')[0]+'.jpg')
