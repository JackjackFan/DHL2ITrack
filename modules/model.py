...
class MDNet(nn.Module):
    def __init__(self, model_path=None,K=1,train = None):
    ...
    def forward(self,x=None,k=0, in_layer='conv1', out_layer='fc6'):
    ...
    def load_model(self, model_path):
        ...
        # pretrained_dict = {k:v for k,v in shared_layers.items()}
        # model_dict.update(pretrained_dict)
        self.layers.load_state_dict(shared_layers)
        # self.layers.load_state_dict(shared_layers,strict=True)
